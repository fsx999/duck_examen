...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExamCenter'
        db.create_table(u'duck_examen_examcenter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('mailling_address', self.gf('django.db.models.fields.TextField')()),
            ('sending_address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('last_name_manager', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('email_bis', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ...
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.Pays'], null=True)),
            ('is_open', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('has_incorporation', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_main_center', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'duck_examen', ['ExamCenter'])

        # Adding model 'RattachementCentreExamen'
        db.create_table(u'duck_examen_rattachementcentreexamen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.InsAdmEtp'])),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('centre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_examen.ExamCenter'])),
            ('ec_manquant', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'duck_examen', ['RattachementCentreExamen'])

        # Adding model 'CentreGestionException'
        db.create_table('core_centregestionexception', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('adresse', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_examen', ['CentreGestionException'])


    def backwards(self, orm):
        # Deleting model 'ExamCenter'
        db.delete_table(u'duck_examen_examcenter')

        # Deleting model 'RattachementCentreExamen'
        db.delete_table(u'duck_examen_rattachementcentreexamen')

        # Deleting model 'CentreGestionException'
        db.delete_table('core_centregestionexception')
    ...
    models = {
        ...
        u'duck_examen.centregestionexameninitial': {
            'Meta': {'object_name': 'CentreGestionExamenInitial', 'db_table': "'core_centregestionexamen'", 'managed': 'False'},
            'adresse': ('django.db.models.fields.TextField', [], {}),
            'adresse_envoi_materiel': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'pays': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_apogee.Pays']"}),
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'telephone': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'})
        },
        u'duck_examen.centregestionexception': {
            'Meta': {'object_name': 'CentreGestionException', 'db_table': "'core_centregestionexception'"},
