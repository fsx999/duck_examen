...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeroulementExamenModel'
        db.create_table('core_deroulementexemenmodel', (
            ...
            ('nb_salle', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nb_table', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('deroulement', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('date_examen', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('salle_examen', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_examen', ['DeroulementExamenModel'])


    def backwards(self, orm):
        # Deleting model 'DeroulementExamenModel'
        db.delete_table('core_deroulementexemenmodel')
