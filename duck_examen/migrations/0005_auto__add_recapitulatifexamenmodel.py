...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecapitulatifExamenModel'
        db.create_table(u'duck_examen_recapitulatifexamenmodel', (
            ...
            ('date_envoie', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_reception', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('anomalie', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('nb_enveloppe', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nb_colis', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'duck_examen', ['RecapitulatifExamenModel'])


    def backwards(self, orm):
        # Deleting model 'RecapitulatifExamenModel'
        db.delete_table(u'duck_examen_recapitulatifexamenmodel')
