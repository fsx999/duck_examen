...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtapeSettingsDerouleModel'
        db.create_table(u'duck_examen_etapesettingsderoulemodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etape', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_apogee.Etape'])),
            ('cod_anu', self.gf('django.db.models.fields.CharField')(default='2014', max_length=4)),
            ('deroule', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
            ('date_envoi_convocation', self.gf('django.db.models.fields.DateField')(null=True)),
            ('envoi_convocation_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('type_examen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_examen.TypeExamen'])),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal(u'duck_examen', ['EtapeSettingsDerouleModel'])

        # Adding field 'RattachementCentreExamen.type_examen'
        db.add_column(u'duck_examen_rattachementcentreexamen', 'type_examen',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='D', to=orm['duck_examen.TypeExamen']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EtapeSettingsDerouleModel'
        db.delete_table(u'duck_examen_etapesettingsderoulemodel')

        # Deleting field 'RattachementCentreExamen.type_examen'
        db.delete_column(u'duck_examen_rattachementcentreexamen', 'type_examen_id')
    ...
    models = {
        ...
        u'duck_examen.etapesettingsderoulemodel': {
            'Meta': {'object_name': 'EtapeSettingsDerouleModel'},
            'cod_anu': ('django.db.models.fields.CharField', [], {'default': "'2014'", 'max_length': '4'}),
            'date_envoi_convocation': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'deroule': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'envoi_convocation_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'etape': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_apogee.Etape']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'type_examen': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_examen.TypeExamen']"})
        },
        ...
        u'duck_examen.rattachementcentreexamen': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'type_examen': ('django.db.models.fields.related.ForeignKey', [], {'default': "'D'", 'to': u"orm['duck_examen.TypeExamen']"})
        },
        ...
        u'duck_examen.typeexamen': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '3', 'primary_key': 'True'})
        }
    }
