...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RattachementCentreExamen.salle'
        db.add_column(u'duck_examen_rattachementcentreexamen', 'salle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['duck_utils.Salle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RattachementCentreExamen.salle'
        db.delete_column(u'duck_examen_rattachementcentreexamen', 'salle_id')
    ...
    models = {
        ...
        u'duck_examen.etapesettingsderoulemodel': {
            ...
            'date_envoi_convocation': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'deroule': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'duck_examen.rattachementcentreexamen': {
            ...
            'salle': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['duck_utils.Salle']", 'null': 'True', 'blank': 'True'}),
            'session': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
